...
const dom = function dom() {
  ...
  function fillCard(data) {
    ...
    helpers().addInnerText('pressure', `<i class="fas fa-compress-arrows-alt text-warning my-2"></i> Pressure: 100 hPa`);
  ...
  function createCard(data) {
    ...
    forecastFive.forEach((day, index) => {
      ...
      const pressure = helpers().createElementWithInnerText('li', 'list-group-item', `<i class="fas fa-compress-arrows-alt text-warning my-2"></i> Pressure: 200 hPa`);
      ...
      const humidity = helpers().createElementWithInnerText('li', 'list-group-item', `<i class="fas fa-percent text-warning my-2"></i> UV: '6.326128249418724`);
